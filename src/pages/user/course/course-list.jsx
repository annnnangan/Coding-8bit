    ...
    <>
          ...
          <div className="row">
            <div className="col title-wrap f-column-align-center d-lg-block">
              ...
              <p className="title-info play-write-font">
                <span className="d-inline-block d-xl-block">Your Journey to Coding Excellence</span>
                <span className="d-inline-block d-xl-block mt-2 mt-lg-0">Starts Here</span>
              </p>
            </div>
            <div className="col text-center">
              <img src="images/deco/Illustration-10.png" alt="banner-illustration" className="banner-illustration" />
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="course-list-category-section wrap">
        <div className="container">
          <MainTitle longTitle={false} beforeTitle="三大類別，豐富多元" afterTitle="" />
              ...
              <div className="col-11 col-lg-4 mt-10 mt-lg-0" key={item.id}>
                <div className="category-card">
                  ...
                  <div className="card-img-wrap">
                    <img src={item.image} alt="banner-illustration" className="card-img w-100" />
                  </div>
                  <div className="card-info text-center bg-white">
                    ...
                    <button onClick={() => handleNavigate(item.category)} className="btn btn-brand-03 fs-7 rounded-3 w-100 mt-2">
                      查看所有影片
                    </button>
                  </div>
                </div>
          ...
          <div className="row position-relative">
            <div className="position-absolute">
              <div className="f-center justify-content-lg-start">
                <picture>
                  <source srcSet="images/icon/icon-infinite-sm.svg" media="(max-width: 575.98px)" />
                  <img src="images/icon/icon-infinite.svg" alt="icon-infinite" />
                </picture>
                <h2 className="title ms-3 ms-lg-4">實用技術短影片</h2>
                <picture>
                  <source srcSet="images/icon/icon-infinite-sm.svg" media="(max-width: 575.98px)" />
                  <img src="images/icon/icon-infinite.svg" alt="icon-infinite" className="ms-3 ms-lg-4" />
                </picture>
              </div>
              <div className="swiper-switch-btn f-align-center gap-5 mt-6">
                <button className="swiper-freeTipShorts-button-prev swiper-circle-btn-prev f-center rounded-circle border-0" style={{ width: "44px", height: "44px" }}></button>
                <button className="swiper-freeTipShorts-button-next swiper-circle-btn-next f-center rounded-circle border-0" style={{ width: "44px", height: "44px" }}></button>
              </div>
            </div>
                    ...
                    <NavLink to={`/course/${course.id}`} className="course-card card-column">
                      <div className="card gradient-border img-hover-enlarge p-lg-6 p-4 h-100">
                        <div className="overflow-hidden img-wrapper rounded position-relative">
                          <img src={course.thumbnail} className="card-img-top cover-img rounded" alt="course-image" />
                        </div>
                        <span className="course-category-tag opacity-75 position-absolute">實用技術短影片</span>
                  ...
                  <a href="video-details.html">
                    <div className="hot-course-card card img-hover-enlarge mt-10 mt-lg-12">
                      <div className="img-wrapper rounded">
                        <img src={course.image} className="cover-img w-100" alt="course-image" />
                      </div>
                      <div className="overlay rounded">
                        <div>
                          <h3 className="text-white fs-4 fw-medium">{course.title}</h3>
                          <p className="text-white mt-2">{course.description}</p>
                        </div>
                      </div>
                      <div className="hot-course-tag position-absolute">
                        <span className="material-symbols-outlined fs-3">arrow_right</span>
      ...
      <section className="course-list-topicSeries-section wrap bg-brand-05">
        <div className="container">
          <MainTitle longTitle={true} beforeTitle="講師自編" afterTitle="主題式系列課程" />
          <div className="row topicSeriesCourse-card-wrap mt-2 mt-lg-8 g-6">
            <CourseCardList courseList={topicSeriesCourseList} />
          </div>
          <div className="f-center">
            <NavLink to="/course?category=topicSeries" className="btn btn-outline-brand-03 slide-right-hover d-inline-flex f-align-center mt-6 mt-lg-11">
              查看所有主題式系列課程影片
              <span className="material-symbols-outlined icon-fill fs-5 ms-1">arrow_forward</span>
            </NavLink>
          </div>
        </div>
      </section>
      ...
      <section className="course-list-customLearning-section wrap">
        <div className="container">
          <MainTitle longTitle={false} beforeTitle="客製化學習需求影片" afterTitle="" />
          <div className="row mt-lg-12">
            <div className="col-lg-4 rounded-1 d-none d-lg-block">
              <ul className="customLearning-list-group list-group bg-white shadow h-100 px-6 py-8" id="customLearning" role="tablist">
                {customLearningCourseList.map((course, index) => (
                  <li role="presentation" key={course.id}>
                    <a
                      href="#"
                      className={`list-group-item list-group-item-action border-0 fs-5 fw-bolder py-4 ${index === activeTab && "active"}`}
            ...
            <div className="col-lg-8 mt-4 mt-lg-10">
              <div className="customLearning-card-wrap tab-content border-0 py-6" id="customLearningContent">
                {customLearningCourseList.map((course, index) => (
                  <div
                    className={`tab-pane bg-white fade ${index === activeTab ? "show active" : "mt-6 mt-lg-0"}`}
                    id={`customLearning-${index}`}
                    role="tabpanel"
                    aria-labelledby={`customLearning-${index}-tab`}
                    key={course.id}
                  >
                    <a href="#" className="course-card card-column">
                      <div className="card border-0 img-hover-enlarge h-100">
                        ...
                        <div className="card-body p-0 mt-4 mt-lg-6 f-column-between">
                          <div>
                            <h3 className="card-title fs-5 fs-lg-4">{course.title}</h3>
                            <p className="card-text fs-7 fs-lg-5 mt-1 mt-lg-2">by {course.tutor}</p>
                            <p className="card-text fs-6 fs-lg-5 mt-2 mt-lg-4">{course.description}</p>
                          </div>
                        </div>
                      </div>
                    </a>
              ...
              <div className="f-center f-lg-end-center">
                <a href="course-list_customLearning.html" className="btn btn-outline-brand-03 slide-right-hover d-inline-flex f-align-center mt-6 mt-lg-8">
                  查看所有客製化需求影片
                  <span className="material-symbols-outlined icon-fill fs-5 ms-1">arrow_forward</span>
                </a>
              </div>
