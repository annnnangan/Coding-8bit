...
export default function TutorBooking() {
  ...
  useEffect(() => {
    serviceSelectionModal.current = new bootstrap.Modal(
      serviceSelectionModalRef.current
    );
  }, []);
  ...
  const getTutorsData = async () => {
    try {
      ...
      const commentResult = await axios.get(
        `${VITE_API_BASE_2}/api/v1/tutors/${id}/comments`
      );
      const availableTimeResult = await axios.get(
        `${VITE_API_BASE_2}/api/v1/tutors/${id}/schedule/availableTime/${currentStartDate}`
      );
    ...
    <>
      <div className="tutor-booking">
        ...
        <div className="position-relative d-lg-none">
          ...
          <span
            className="material-symbols-outlined icon-fill text-white position-absolute top-50 start-50 translate-middle"
            style={{ fontSize: "56px" }}
          >
            play_circle
          </span>
            ...
            <div className="col-lg-8">
              ...
              <section className="section">
                ...
                <div className="tutor-profile section-component">
                  ...
                  <div className="flex-grow-1">
                    ...
                    <p className="fs-lg-5 fs-6 text-gray-02">
                      {tutorList.title}
                    </p>
                  </div>
                </div>
                ...
                <div className="list-x-scroll py-2 section-component">
                  {tutorList.skills.map((skill, index) => (
                    <a
                      href="#"
                      className="tag tag-brand-02 fs-8 me-3"
                      key={index}
                    >
                      {skill}
                    </a>
                ...
                <div className="section-component">
                  <ul
                    className="nav nav-tabs mb-6 list-x-scroll flex-nowrap"
                    id="myTab"
                    role="tablist"
                  >
                  ...
                  <div className="tab-content" id="myTabContent">
                    ...
                    <div
                      ...
                      id="teaching-styles-tab-pane"
                      role="tabpanel"
                      aria-labelledby="teaching-styles-tab"
                      tabIndex="0"
                    >
                  ...
                  <div className="swiper-wrapper">
                    {courses.map((course) => (
                      <div className="swiper-slide" key={course.id}>
                        <CourseCard courseList={course} cardsNum={1} />
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <section className="section schedule">
                ...
                <div className="f-between-center mb-5">
                  <span className="prev material-symbols-outlined icon-fill bg-brand-02 text-brand-01 rounded-circle p-2 align-middle">
                    arrow_back
                  </span>
                  <h5 className="text-brand-03 week fw-medium">
                    {availableTime[0]?.year}/{availableTime[0]?.date} -{" "}
                    {availableTime[0]?.year}/
                    {availableTime[availableTime.length - 1]?.date}
                  </h5>
                  <span className="next material-symbols-outlined icon-fill bg-brand-02 text-brand-01 rounded-circle p-2 align-middle">
                    arrow_forward
                  </span>
                </div>
            ...
            <div className="col-lg-4 d-lg-block d-none">
              <div className="desktop-cta-card card p-lg-6 p-4 sticky-top">
                ...
                <div className="card-body p-0">
                  ...
                  <button
                    className="btn slide-right-hover btn-brand-03 w-100"
      ...
      <div
        className="modal fade service-selection-modal"
        id="serviceSelectionModal"
        tabIndex="-1"
        aria-labelledby="serviceSelectionModalLabel"
        aria-hidden="true"
        ref={serviceSelectionModalRef}
      >
            ...
            <div className="modal-body">
              ...
              <div className="row row-cols-lg-2 g-4 flex-column flex-lg-row">
                ...
                <div className="col service-card">
                  <button
                    className="h-100 border-0"
                    onClick={() => toPaymentPage("code-review")}
                  >
                    <div className="f-center flex-column bg-gray-04 py-8 px-5 rounded-2 slide-up-hover h-100">
      ...
      <div
        className="mobile-bottom-cta d-lg-none sticky-bottom border border-2 border-brand-02 bg-white"
      ...
      >
        <div className="pt-4 pb-6 px-4">
          <div className="f-between-center">
            ...
            <button
              className="btn slide-right-hover btn-brand-03"
              data-bs-toggle="modal"
              data-bs-target="#serviceSelectionModal"
            >
              <p className="f-center me-1">
