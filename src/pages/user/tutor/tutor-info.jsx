              ...
              <div className="tutor-content-info px-6 mt-6 mt-lg-8">
                ...
                <ul className="d-flex mt-6 mt-lg-8">
                  ...
                  <li className="ms-3">
                    <a href="#" className="icon-hover">
                      <img
                        src="images/icon/icon-mail-purple.svg"
                        alt="icon-ins"
                      />
                    </a>
                  </li>
                  ...
                  >
                    <div className="row mt-6 mt-lg-8 g-6">
                      {item.category === "topicSeries" && (
                        <CourseCard courseList={courses.topicSeries} />
                      )}
                      {item.category === "customLearning" && (
                        <CourseCard courseList={courses.customLearning} />
                      )}
                      {item.category === "freeTipShorts" && (
                        <CourseCard courseList={courses.freeTipShorts} />
                      )}
                    </div>
                  </div>
                ))}
