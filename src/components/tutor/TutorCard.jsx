    ...
    <div className="card p-lg-5 p-md-4 p-4 img-hover-enlarge h-100" style={{ boxShadow: "0px 25px 50px -12px #0000001F" }}>
      <div className="card-body p-0 d-flex flex-column">
        ...
        <div className="mb-lg-6 mb-5 mt-auto">
          ...
          {/* dynamic price */}
          <h2 className="text-brand-03 fs-lg-2 fs-3">NT $ {Number(tutor.hourly_rate).toLocaleString("en-IN")}</h2>
        </div>
        <div className="position-relative">
          {/* dynamic favorite status */}
          <span
            className={`favorite material-symbols-outlined icon-fill p-2 mb-2 rounded-circle align-middle ${isBookmark ? "text-brand-01" : "text-gray-03"}`}
            role="button"
